...
<head>
    <meta charset="UTF-8">
    <title>Burger Nusantara - Daftar Minuman</title>
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            ...
            <div>
                <a href="CreateMinuman.jsp" class="btn btn-update btn-sm"><i class="fas fa-plus"></i> Menu Minuman</a>
            </div>
            <br>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <a href="UpdateMinuman.jsp?id=<%= resultSet.getString("id") %>" class="btn btn-update btn-sm"><i class="fas fa-edit"></i> Ubah</a>
                                    <a href="DeleteMinuman.jsp?id=<%= resultSet.getString("id") %>" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i> Hapus</a>
                                </div>
                            </td>
                        </tr>
                    <% 
