<%-- 
    Document   : CreateMakanan
    Created on : Jul 15, 2024, 6:43:37 PM
    Author     : kikig
--%>
...
<body>
        ...
        <div class="container">
            ...
            <div class="create-form">
                <form action="" method="post">
                    ...
                    <button type="submit" class="btn btn-submit" name="createmakanan">Tambahkan</button>
                </form>
            </div>
        </div>
    </div>
    ...
    <% 
        ...
        if (nama != null && varian != null && stock != null && harga != null) {
