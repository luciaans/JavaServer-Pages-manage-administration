<%-- 
    Document   : UpdateMinuman
    Created on : Jul 4, 2024, 2:51:10 PM
    Author     : kikig
--%>
        ...
        <div class="container">
            ...
            <div class="update-form">
                ...
                try {
                    ...
                    if(resultSet.next()) {
                %>
                        <form action="ProcessUpdateMinuman.jsp" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="merek" name="merek" class="form-control" value="<%= resultSet.getString("merek") %>" required>
                            </div>
                            <div class="form-group">
